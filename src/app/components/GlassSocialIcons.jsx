    ...
    <div className="w-full relative">
      ...
      <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4 lg:gap-5 p-3 sm:p-4 lg:p-5">
        ...
        <GlassIcon href="#" icon="instagram">
          <House />
          <span className="text-xs">Estates</span>
        </GlassIcon>
...
const GlassIcon = ({ href, icon, children }) => {
  return (
    <a
      href={href}
      className="group relative w-17.5 h-17.5 sm:w-20 sm:h-20 lg:w-25 lg:h-25 rounded-full flex flex-col items-center justify-center text-white bg-gray-900 backdrop-blur-sm border border-white/20 border-r-white/10 border-b-white/10 shadow-[0_20px_30px_rgba(0,0,0,0.1)] no-underline overflow-hidden transition-all duration-200 hover:-translate-y-5"
    >
      {/* Shine effect */}
