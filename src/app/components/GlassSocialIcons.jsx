...
const GlassIcon = ({ href, icon, children }) => {
  return (
    <a
      href={href}
      className="group relative w-[70px] h-[70px] sm:w-[80px] sm:h-[80px] lg:w-[100px] lg:h-[100px] rounded-full flex flex-col items-center justify-center text-white bg-[#1c345a] backdrop-blur-sm border border-white/20 border-r-white/10 border-b-white/10 shadow-[0_20px_30px_rgba(0,0,0,0.1)] no-underline overflow-hidden transition-all duration-200 hover:-translate-y-5"
    >
      {/* Shine effect */}
